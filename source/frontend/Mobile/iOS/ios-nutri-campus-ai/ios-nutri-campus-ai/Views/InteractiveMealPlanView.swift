...
//
//            mealSection(title: "Breakfast", dishes: day.Breakfast.dishes,day:title,time:day.Breakfast.time)
//            mealSection(title: "Lunch", dishes: day.Lunch.dishes,day:title,time:day.Breakfast.time)
//            mealSection(title: "Dinner", dishes: day.Dinner.dishes,day:title,time:day.Breakfast.time)
//        }
//        .padding()
...
//        let now = Date()
//
//        // Tách giờ/phút từ time.start
//        let components = time.start.split(separator: ":").compactMap { Int($0) }
//        guard components.count == 2 else { return true } // nếu format sai, mặc định cho phép
//
//        // Lấy ngày hôm nay, gán giờ/phút
//        var dateComponents = calendar.dateComponents([.year, .month, .day], from: now)
//        dateComponents.hour = components[0]
//        dateComponents.minute = components[1]
//        dateComponents.second = 0
